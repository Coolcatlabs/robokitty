...
LEG_SERVO_CONFIG: Dict[LegID, List[ServoJointConfig]] = {
    ...
    LegID.RL: [
        ...
        ServoJointConfig(servo_id=4,  offset_deg=0.0, inverted=False),   # RL Leg
    ],
    LegID.RR: [
        ...
        ServoJointConfig(servo_id=6,  offset_deg=0.0, inverted=True),    # RR Leg
    ],
}
    ...
    def identify_all_servos(self):
        ...
        for leg_id in LegID:
            ...
            for cfg, name in zip(configs, joint_names):
                ...
                self.servos.identify_servo(cfg.servo_id, flashes=7)
                time.sleep(0.5)
